 ...
 * <p>
 * This method is blocking as it looks up the cache. So it could cause lags on
 * big servers. Because we only need the name this class is made.
 * <p>
 * Bukkit already implemented methods to get around this problem, but the
 * scoreboard team isn't yet modified for methods, which can be called just with
 * a string.
 * <p>
